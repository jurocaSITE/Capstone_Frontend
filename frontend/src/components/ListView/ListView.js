...
export default function ListView({bookList, handleOnRemove, handleOnTransfer, handleOnCopy, errorMessage}) {
   
    return (
		<div className="ListView">
            {bookList.map((book) => (
                <div className="row">
                    <DetailedListRow book={book} handleOnRemove={handleOnRemove} handleOnCopy={handleOnCopy} handleOnTransfer={handleOnTransfer} errorMessage={errorMessage}/>
                </div>	
            ))}
		</div>
	);

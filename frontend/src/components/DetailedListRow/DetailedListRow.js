				...
				<div className="row-item">
					...
					{showMenu && (
						<ul className="options">
							...
							<a
								href={`#modal-opened-${book.id}-transfer`}
								className="link-1"
								id="modal-closed"
							>
								{user && book.id ? (
							...
							<a
								href={`#modal-opened-${book.id}-copy`}
								className="link-1"
								id="modal-closed"
							>
					...
					{lists.map((list) => (
						<button
							...
							onClick={() => {
								...
								console.log(
									"transfer and delete should have successfully happened"
								);
							}}
						>
							{list.list_name}
					...
					{lists.map((list) => (
						<button
							...
							onClick={() => {
								...
								console.log("book.id", book.id, "book title is", book.title);
								console.log(
									"copying book to another list successfully happened"
								);
							}}
						>
							{list.list_name}
